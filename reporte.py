...
class reportePDF(object):
    ...
    def _encabezadoPiePagina(canvas, archivoPDF):
        ...
        # Encabezado
        encabezadoNombre = Paragraph("REPORTE", estilos["Normal"])
        ...
        # Pie de página
        piePagina = Paragraph("sistema de historia clinica", estilos["Normal"])
...
def generarReporte():
    ...
    cursor.execute("SELECT DNI_PER, APE_PER, NOM_PER, ID_AREA_PER FROM PERSONAS")
